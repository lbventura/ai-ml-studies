...
image = np.array([[0, 10, 9, 10, 0],
                  [0, 0, 0, 10, 0],
                  [0, 10, 9, 10, 0],
                  [0, 0, 0, 10, 0],
                  [0, 10, 9, 10, 0]], dtype=np.uint8)


# Define the vertical Sobel kernel
filter_mat = np.array([[0, 1, 0],
                                  [0, 1, 0],
                                  [0, 1, 0]])

vertical_edges = cv2.filter2D(image, -1, filter_mat) # activates when it turns from white to black
