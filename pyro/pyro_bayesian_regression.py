...
def regression_training(x_data, y_data, loss_fn, optim, NUM_ITERATIONS, regression_model):
...
if __name__ == '__main__':
    ...
    if TRAIN_REGRESSION_MODEL:
        ...
        regression_training(x_data, y_data, loss_fn, optim, NUM_ITERATIONS, regression_model)
